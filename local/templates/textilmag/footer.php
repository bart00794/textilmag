...
<!--                <img src="--><?//=SITE_TEMPLATE_PATH;?><!--/img/others/payments-2.png" alt="Payment">-->
            </div>
        </div>
    </div>
</footer>
        ...
        <div class="side-navigation-inner">
            ...
            <div class="widget pt--30 pr--20">
                <div class="text-widget">
                    <p>
                        <img src="<?=SITE_TEMPLATE_PATH;?>/img/others/payments.png" alt="payment">
                    </p>
                ...
                <ul class="mini-cart__list">
                    <li class="mini-cart__product">
                        ...
                        <div class="mini-cart__product__image">
                            <img src="<?=SITE_TEMPLATE_PATH;?>/img/products/prod-17-1-70x91.jpg" alt="products">
                        </div>
                    ...
                    <li class="mini-cart__product">
                        ...
                        <div class="mini-cart__product__image">
                            <img src="<?=SITE_TEMPLATE_PATH;?>/img/products/prod-18-1-70x91.jpg" alt="products">
                        </div>
                        <div class="mini-cart__product__content">
                    ...
                    <li class="mini-cart__product">
                        ...
                        <div class="mini-cart__product__image">
                            <img src="<?=SITE_TEMPLATE_PATH;?>/img/products/prod-19-1-70x91.jpg" alt="products">
                        </div>
                        <div class="mini-cart__product__content">
                            <a class="mini-cart__product__title" href="product-details.html">Waxed-effect pleated skirt</a>
                            <span class="mini-cart__product__quantity">1 x $49.00</span>
                    ...
                    <li class="mini-cart__product">
                        ...
                        <div class="mini-cart__product__image">
                            <img src="<?=SITE_TEMPLATE_PATH;?>/img/products/prod-2-1-70x91.jpg" alt="products">
                        </div>
                        <div class="mini-cart__product__content">
                            <a class="mini-cart__product__title" href="product-details.html">Waxed-effect pleated skirt</a>
                            <span class="mini-cart__product__quantity">1 x $49.00</span>
                    ...
                    <div class="col-md-6">
                        ...
                        >
                            <div class="product-image">
                                <div class="product-image--holder">
                                    <a href="product-details.html">
                                        <img src="<?=SITE_TEMPLATE_PATH;?>/img/products/prod-9-1.jpg" alt="Product Image" class="primary-image">
                                    </a>
                                </div>
                            ...
                            <div class="product-image">
                                <div class="product-image--holder">
                                    <a href="product-details.html">
                                        <img src="<?=SITE_TEMPLATE_PATH;?>/img/products/prod-10-1.jpg" alt="Product Image" class="primary-image">
                                    </a>
                                </div>
                            ...
                            <div class="product-image">
                                <div class="product-image--holder">
                                    <a href="product-details.html">
                                        <img src="<?=SITE_TEMPLATE_PATH;?>/img/products/prod-11-1.jpg" alt="Product Image" class="primary-image">
                                    </a>
                                </div>
